...
{
#if LCD_MODE == LCD_8BITMODE
	DIO_vidSetPinValue(Control_Port , RS , DIO_u8LOW);
	DIO_vidSetPinValue(Control_Port , RW , DIO_u8LOW);

	DIO_vidSetPortValue(Data_Port , Cmd);

	DIO_vidSetPinValue(Control_Port , EN , DIO_u8HIGH);

	_delay_ms(5);

	DIO_vidSetPinValue(Control_Port , EN , DIO_u8LOW);
...
{
#if LCD_MODE == LCD_8BITMODE
	DIO_vidSetPinValue(Control_Port , RS , DIO_u8HIGH);
	DIO_vidSetPinValue(Control_Port , RW , DIO_u8LOW);
