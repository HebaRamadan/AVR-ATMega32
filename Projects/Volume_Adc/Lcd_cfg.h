...
#define LCD_u8RS_PIN DIO_u8PIN_16      //RS at PORTA PIN_0
#define LCD_u8RW_PIN DIO_u8PIN_17	  //RW at PORTA PIN_0
#define LCD_u8EN_PIN DIO_u8PIN_18	  //EN at PORTA PIN_0
